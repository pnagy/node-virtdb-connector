...
VirtDBConnector = (function() {
  ...
  VirtDBConnector.connect = function(name, connectionString) {
    var endpoint;
    VirtDBConnector.handler = new Protocol.EndpointHandler(connectionString, VirtDBConnector.onEndpoint);
    endpoint = {
      Endpoints: [
        {
          Name: name,
  ...
  VirtDBConnector.close = function() {
    var _ref;
    return (_ref = VirtDBConnector.handler) != null ? _ref.close() : void 0;
  };
  ...
  VirtDBConnector.OnBound = function(name, socket, svcType, zmqType) {
    return function(err) {
      ...
      return this.handler.send(endpoint);
    };
  };
