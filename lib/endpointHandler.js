...
EndpointHandler = (function() {
  ...
  EndpointHandler.prototype.onEndpoint = function(endpoint) {
    var callback, connection, _i, _len, _ref, _ref1, _ref2, _results;
    if (endpoint.Connections != null) {
      _ref = endpoint.Connections;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        connection = _ref[_i];
        if (((_ref1 = this.Handlers) != null ? (_ref2 = _ref1[endpoint.SvcType]) != null ? _ref2[connection.Type] : void 0 : void 0) != null) {
          _results.push((function() {
            var _j, _len1, _ref3, _ref4, _ref5, _results1;
            _ref5 = (_ref3 = this.Handlers) != null ? (_ref4 = _ref3[endpoint.SvcType]) != null ? _ref4[connection.Type] : void 0 : void 0;
            _results1 = [];
