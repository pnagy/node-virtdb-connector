...
FieldData = (function() {
  ...
  FieldData.createInstance = function(type) {
    switch (type) {
      case "STRING":
        return new StringFieldData(type);
      case "INT32":
        return new Int32FieldData(type);
      case "INT64":
        return new Int64FieldData(type);
      case "UINT32":
        return new UInt32FieldData(type);
      case "UINT64":
        return new UInt64FieldData(type);
      case "DOUBLE":
        return new DoubleFieldData(type);
      case "FLOAT":
        return new FloatFieldData(type);
      case "BOOL":
        return new BoolFieldData(type);
      case "BYTES":
        return new BytesFieldData(type);
      default:
        return new StringFieldData(type);
    }
  };
  ...
  FieldData.createInstanceFromField = function(field) {
    return this.createInstance(field.Desc.Type);
  };

  FieldData.get = function(data) {
    var local;
    local = FieldData.createInstance(data.Data.Type);
...
Int32FieldData = (function(superClass) {
  ...
  function Int32FieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    Int32FieldData.__super__.constructor.call(this, type);
...
Int64FieldData = (function(superClass) {
  ...
  function Int64FieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    Int64FieldData.__super__.constructor.call(this, type);
...
UInt32FieldData = (function(superClass) {
  ...
  function UInt32FieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    UInt32FieldData.__super__.constructor.call(this, type);
...
UInt64FieldData = (function(superClass) {
  ...
  function UInt64FieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    UInt64FieldData.__super__.constructor.call(this, type);
...
DoubleFieldData = (function(superClass) {
  ...
  function DoubleFieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    DoubleFieldData.__super__.constructor.call(this, type);
...
FloatFieldData = (function(superClass) {
  ...
  function FloatFieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    FloatFieldData.__super__.constructor.call(this, type);
...
BoolFieldData = (function(superClass) {
  ...
  function BoolFieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    BoolFieldData.__super__.constructor.call(this, type);
...
BytesFieldData = (function(superClass) {
  ...
  function BytesFieldData(type) {
    this.get = bind(this.get, this);
    this.getArray = bind(this.getArray, this);
    this.pushValueType = bind(this.pushValueType, this);
    this.push = bind(this.push, this);
    BytesFieldData.__super__.constructor.call(this, type);
