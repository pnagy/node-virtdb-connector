...
FieldData = (function() {
  ...
  FieldData.createInstance = function(type) {
    switch (type) {
      ...
      case "INT32":
        return new Int32FieldData();
      case "INT64":
        return new Int64FieldData();
      case "UINT32":
        return new UInt32FieldData();
      case "UINT64":
        return new UInt64FieldData();
      case "DOUBLE":
        return new DoubleFieldData();
      case "FLOAT":
        return new FloatFieldData();
      case "BOOL":
        return new BoolFieldData();
      case "BYTES":
        return new BytesFieldData();
      default:
        return new StringFieldData();
    }
  };
